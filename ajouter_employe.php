...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        if(isset($_FILES['photo_identite']) && $_FILES['photo_identite']['error'] === UPLOAD_ERR_OK) {
            ...
            $upload_dir = './img/PI/'; // Remplacez par votre chemin
...
<head>
  ...
  <style>
    /* Style pour mettre en surbrillance la ligne sélectionnée */
    .highlight-row {
      background-color: #cce5ff !important; /* Couleur de surbrillance */
    }
  </style>
</head>
